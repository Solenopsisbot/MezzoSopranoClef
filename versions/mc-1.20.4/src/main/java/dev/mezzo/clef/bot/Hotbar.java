 ...
 * a single {@link ClickType#SWAP} click) and then select it.</p>
 *
...
public final class Hotbar {
    ...
    public static Selection select(Minecraft mc, Item item, Integer preferredSlot) {
        ...
        mc.gameMode.handleInventoryMouseClick(handler.containerId, sourceSlot.index, target, ClickType.SWAP, mc.player);
        inv.selected = target;
